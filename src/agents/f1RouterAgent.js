    ...
    try {
      ...
      if (routedAgent === 'OFF_TOPIC') {
        return {
          ...
          message:
            "I'm here to help with Formula 1 queries only. Please ask me about F1 races, drivers, constructors, championships, or circuit information!",
        };
      }
      ...
      if (routedAgent === 'INAPPROPRIATE') {
        return {
          ...
          message:
            "I'm here to provide helpful Formula 1 information in a respectful manner. Please ask me about F1 races, drivers, or championship data!",
        };
      }
      ...
      const finalAgent = validAgents.includes(routedAgent)
        ? routedAgent
        : 'RACE_RESULTS';
...
`;
  ...
  calculateConfidence(query, routedAgent) {
    ...
    const matchCount =
      keywords[routedAgent]?.filter((keyword) =>
